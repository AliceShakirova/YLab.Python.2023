...
@pytest.mark.asyncio
@pytest.mark.order(1)
async def test_post_menu(start_clear_storage: Callable) -> None:
...
@pytest.mark.asyncio
@pytest.mark.order(2)
async def test_post_submenu() -> None:
...
@pytest.mark.asyncio
@pytest.mark.order(3)
async def test_post_dish_1() -> None:
...
@pytest.mark.asyncio
@pytest.mark.order(4)
async def test_post_dish_2() -> None:
    test_request_payload = {'title': 'My dish 1', 'description': 'My dish description 1', 'price': '12.50'}
    test_response_payload = {'id': '', 'title': 'My dish 1', 'description': 'My dish description 1', 'price': '12.50'}
    response = await client.post(func_reverse('post_dish', menu_id=menu_id, submenu_id=submenu_id),
                                 json=test_request_payload)
...
@pytest.mark.asyncio
@pytest.mark.order(5)
async def test_get_target_menu_1() -> None:
...
@pytest.mark.asyncio
@pytest.mark.order(6)
async def test_get_target_submenu() -> None:
...
@pytest.mark.asyncio
@pytest.mark.order(7)
async def test_delete_submenu() -> None:
...
@pytest.mark.asyncio
@pytest.mark.order(8)
async def test_get_all_submenu_empty() -> None:
...
@pytest.mark.asyncio
@pytest.mark.order(9)
async def test_get_all_dish_empty() -> None:
    test_response_payload: list = []
...
async def test_get_target_menu_2() -> None:
    test_response_payload = {'id': menu_id, 'title': 'My menu 1', 'description': 'My menu description 1',
...
async def test_delete_menu() -> None:
...
async def test_get_all_menu_empty() -> None:
    test_response_payload: list = []
