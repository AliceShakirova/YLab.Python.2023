...
def test_get_all_menu(clear_storage, insert_inst):
    ...
    test_response_payload[0] = insert_inst(Menu, updated=False, storage=conftest.ADD_TO_CACHE)
...
def test_get_target_menu(clear_storage, insert_inst):
    test_response_payload = insert_inst(Menu, updated=False, storage=conftest.ADD_TO_CACHE)
